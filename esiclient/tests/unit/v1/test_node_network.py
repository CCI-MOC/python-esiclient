...
class TestList(base.TestCommand):
    ...
    def test_take_action_no_network(self, mock_network_list):
    ...
    @mock.patch('esi.lib.nodes.network_list')
    def test_take_action_multiple_nodes(self, mock_network_list):
        mock_network_list.return_value = [
            {
                'node': self.node1,
                'network_info': [
    ...
    @mock.patch('esi.lib.nodes.network_list')
    def test_take_action_multiple_ports(self, mock_network_list):
        mock_network_list.return_value = [
            {
                'node': self.node2,
                'network_info': [
    ...
    @mock.patch('esi.lib.nodes.network_list')
    def test_take_action_port_forwardings(self, mock_network_list):
        mock_network_list.return_value = [
            {
                'node': self.node1,
                'network_info': [
    ...
    @mock.patch('esi.lib.nodes.network_list')
    def test_take_action_trunk(self, mock_network_list):
        mock_network_list.return_value = [
            {
                'node': self.node2,
                'network_info': [
